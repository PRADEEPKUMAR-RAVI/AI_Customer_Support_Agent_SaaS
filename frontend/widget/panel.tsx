...
:host {
  ...
  --muted-foreground: oklch(0.47 0.015 55);
...
@media (prefers-color-scheme: dark) {
  :host {
    ...
    --card: oklch(0.21 0.005 260);
    --secondary: oklch(0.27 0.006 260);
    --muted-foreground: oklch(0.72 0.015 55);
    --primary: var(--brand-primary);
    --primary-foreground: oklch(1 0 0);
...
.csw-root { --csw-focus: color-mix(in srgb, var(--primary, #0d3b66) 55%, transparent); }
...
.csw-root .csw-chip:hover { transform: translateY(-1px); border-color: var(--primary, #0d3b66); }
...
.csw-root .csw-composer:focus-within { border-color: var(--primary, #0d3b66); box-shadow: 0 0 0 3px var(--csw-focus); }
