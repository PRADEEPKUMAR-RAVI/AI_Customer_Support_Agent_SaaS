    ...
    <div>
      ...
      {schemaQ.isError ? (
        <ErrorState
          ...
          message="We couldn't fetch your record templates. Check your connection and try again."
          ...
          <TabsContent value="datasets" className="space-y-4">
            {loading ? (
              ...
              <EmptyState
                ...
                description="There are no record templates yet. Once an industry template is set up, its datasets appear here."
              />
            ) : (
              <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                {schemas.map((s) => {
