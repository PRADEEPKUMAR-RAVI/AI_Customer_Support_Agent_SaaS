...
export function KnowledgePage() {
  ...
  if (role && !hasPermission(role, "kb:manage")) {
    return (
      <>
        <PageHeader title="Knowledge base" description="The content your agent answers from." />
  ...
  return (
    <>
      <PageHeader
        ...
        description="Add and manage the docs, FAQs, and pages your agent answers from."
        actions={<UploadForm />}
      />
      <SourceList />
    </>
